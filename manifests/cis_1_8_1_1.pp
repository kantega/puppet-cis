...
#
# @summary 1.8.1.1 Ensure message of the day is configured properly (Scored)
#
# @example
#   include cis::1_8_1_1
class cis::cis_1_8_1_1 (
  Boolean $enforced = true,
) {
  if $enforced {
    if $facts['cis_1_8_1_1'] {
      notify { 'cis_1_8_1_1':
        message  => 'Not in compliance with CIS 1.8.1.1 (Scored). There is OS and/or patch level information in /etc/motd',
        loglevel => 'warning',
      }
    }
  }
